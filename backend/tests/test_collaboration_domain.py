...
async def test_team_creation(async_client, db_session):
    db = db_session
...
async def test_duplicate_team_name_per_hackathon(async_client, db_session):
    db = db_session
...
async def test_project_creation_and_technologies(async_client, db_session):
    db = db_session
...
async def test_one_project_per_team(async_client, db_session):
    db = db_session
