"""Add TrustVerification model

Revision ID: e6deb8e87e5a
Revises: 93698e4fa0e1
Create Date: 2026-08-11 15:36:08.758628
...
revision: str = 'e6deb8e87e5a'
down_revision: Union[str, None] = '93698e4fa0e1'
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('graph_edges', schema=None) as batch_op:
        ...
        batch_op.alter_column('id',
               ...
               type_=sa.UUID(),
               existing_nullable=False)
        batch_op.create_index('ix_graph_edges_ws_provenance', ['workspace_id', 'provenance'], unique=False)
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('graph_edges', schema=None) as batch_op:
        batch_op.drop_index('ix_graph_edges_ws_provenance')
        batch_op.alter_column('id',
               existing_type=sa.UUID(),
               type_=sa.NUMERIC(),
               existing_nullable=False)
