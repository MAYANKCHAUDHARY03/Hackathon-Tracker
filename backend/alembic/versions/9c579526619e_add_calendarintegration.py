...
Revision ID: 9c579526619e
Revises: 6210b9a9f588
Create Date: 2026-08-06 21:15:56.724665
...
revision: str = '9c579526619e'
down_revision: Union[str, None] = '6210b9a9f588'
...
def upgrade() -> None:
    ...
    sa.Column('remote_calendar_id', sa.String(length=255), nullable=True),
    ...
    with op.batch_alter_table('calendar_integrations', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_calendar_integrations_workspace_id'), ['workspace_id'], unique=False)
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('calendar_integrations', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_calendar_integrations_workspace_id'))
